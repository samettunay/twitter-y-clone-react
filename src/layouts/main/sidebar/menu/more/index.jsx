    ...
    return (
        <Popover className="relative">
            <Popover.Button className="py-[3px] block group outline-none">
                <div className="p-3 rounded-full text-[color:var(--color-base)] transition-colors inline-flex items-center gap-5 group-hover:bg-[color:var(--background-third)]">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-[0] overflow-hidden rounded-xl bg-[color:var(--background-primary)] shadow-[color:var(--box-shadow)] border border-[color:var(--background-border)] overflow-hidden">
                <button className="p-3 h-14 w-full transition-colors inline-flex items-center gap-5 text-[color:var(--color-base)] hover:bg-[color:var(--background-third)]">
                    <div className="w-[26.25px] h-[26.25px] relative">
                        <svg viewBox="0 0 24 24" width="26.25" height="26.25" className="block">
                            <path
                                fill="currentColor"
                ...
                <button className="p-3 h-14 w-full text-[color:var(--color-base)] transition-colors inline-flex items-center gap-5 hover:bg-[color:var(--background-third)]">
                    <div className="w-[26.25px] h-[26.25px] relative">
                        <svg viewBox="0 0 24 24" width="26.25" height="26.25" className="block">
                            <path
                                fill="currentColor"
                ...
                <button
                    ...
                    className="p-3 h-14 w-full text-[color:var(--color-base)] transition-colors inline-flex items-center gap-5 hover:bg-[color:var(--background-third)]">
                    <div className="w-[26.25px] h-[26.25px] relative">
